                        ...
                        ?(
                            <div>
                                <section>
                                    <div>
                                        <h2>
                                            <GoTriangleRight className="react-icons" size={13} /> Add Invoice
                                        </h2>
                                    </div>
                                </section>
                                <section>
                                <div>
                                        <h2>
                                            <GoTriangleRight className="react-icons" size={13} /> View &amp; Modify Invoices
                                        </h2>
                                    </div>
                                </section>
                            </div>
                            // <div>
                            //     <AddInvoiceForm selectCustomer={selectCustomer} usersList={usersList}/>
...
export default connect(mapStateToProps, { requestUserData })(ManageInvoices);